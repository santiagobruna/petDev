...
export function Hero () {
    return(
        <section className="bg-[#E84C3D] text-white relative overflow-hidden">
            <div>
                <Image  src={dogImg} alt='Foto do cachorro' fill sizes='100vw' priority className='object-contain opacity-60 lg:hidden'/>
                ...
                <article className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
                        <div className='space-y-6'>
                            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-10" data-aos="fade-down">
                                ...
                                <p className=" lgF:text-lg" data-aos="fade-right">
                                Oferecemos os melhores serviços para garantir o bem-estar e a felicidade do seu amigo de quatro patas.
                                </p>
                                <div>
                                    <a data-aos="fade-up" data-aos-delay="500" target='_blank' href={`https://wa.me/5521975956657?text=Olá vim pelo site e gostaria de mais informações`}
                        ...
                        <div className='hidden md:block h-full relative'>
                            <Image src={dogImg} alt='Foto do dog' className='object-contain' fill sizes='(max-width: 0vw, 50vw)' quality={100} priority/>
